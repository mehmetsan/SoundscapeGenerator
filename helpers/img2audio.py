...
def wav_bytes_from_spectrogram_image(image: Image.Image, duration: int, nmels: int, maxvol: int, power_for_image: float) -> tp.Tuple[io.BytesIO, float]:
    """
...
wav_bytes, duration_s = wav_bytes_from_spectrogram_image(image,
                                                         ...
                                                         nmels=int(args.nmels),
                                                         maxvol=int(args.maxvol),
